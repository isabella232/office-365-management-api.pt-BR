...
> [!NOTE] 
> A resposta do serviço conterá o status de 24 horas a partir de quando a solicitação foi feita. O valor StatusDate ou StatusTime retornado estará exatamente 24 horas no passado. 
